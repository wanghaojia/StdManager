        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/grade/save.action"
                              method="post">

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="name">班级名字</label>

                                <div class="col-sm-9">
                                    <input type="text" id="name" name="name" required="required"
                                           class="col-xs-10 col-sm-5"
                                           value="${(gradeOperateVo != null) ? gradeOperateVo.gradeVo.name : ""}"
                                            maxlength="20"/>
                                </div>
                            </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        if (${gradeOperateVo.error != null}) {
            $.gritter.add({
                title: '出错了!',
                text: '${gradeOperateVo.error}',
                time: 1000,
