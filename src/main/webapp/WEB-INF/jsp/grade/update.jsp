                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form"
                              action="${pageContext.request.contextPath}/grade/update.action" method="post">

                            <input type="hidden" name="id" value="${gradeOperateVo.gradeVo.id}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="name" name="name" class="col-xs-10 col-sm-5"
                                           required="required"
                                           value="${gradeOperateVo.gradeVo.name}"
                                           maxlength="20"/>
                                </div>
                            </div>
