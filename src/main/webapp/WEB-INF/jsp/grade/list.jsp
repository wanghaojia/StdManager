...
<head>
    ...
    <script>
        ...
        function onUpdateClick(gradeId) {
            doPost(
                '${pageContext.request.contextPath}/grade/toUpdate.action',
                {
                    "id": gradeId
                }
            );
        ...
        function onSureDeleteClick() {
            doPost(
                '${pageContext.request.contextPath}/grade/delete.action',
                {
                    "id": deleteGradeId
                }
            );
        ...
        function onPageClick(index) {
            doPost(
                '${pageContext.request.contextPath}/grade/list.action',
                {
                    "pageIndex": index
                }
            );
