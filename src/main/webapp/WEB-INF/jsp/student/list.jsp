...
<head>
    ...
    <script>
        ...
        function onOperateClick(studentId, url) {
            doPost(
                url,
                {
                    "id": studentId
        ...
        function onDeleteClick(studentId) {
            deleteId = studentId;
        }

        function onSureDeleteClick() {
            doPost(
                '${pageContext.request.contextPath}/student/delete.action',
                {
                    "id": deleteId
                }
            );
        ...
        function onPageClick(index) {
            console.log(index);
            doPost(
                '${pageContext.request.contextPath}/student/list.action',
                {
                    "pageIndex": index
                }
            );
                                ...
                                <div class="pull-left">
                                    ...
                                    <div class="dropdown dropdown-colorpicker">
                                        <a data-toggle="dropdown" class="dropdown-toggle">
                                            <span
                                            class="btn-colorpicker" style="background-color:#438EB9"></span>
                                        </a>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <c:choose>
                                    <c:when test="${studentListVo.pageVo.pageCount > 0}">
                                        ...
                                        <table id="simple-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <c:forEach var="index" begin="0"
                                                       end="${studentListVo.studentVoList.size()-1}" step="1">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:out value="${studentListVo.studentVoList.get(index).gradeName}"/>
                                                    </td>

                                                    <td>
                                                        <c:out value="${studentListVo.studentVoList.get(index).subjectCount}"/>
                                                    </td>

                                                    <td>
                                                        <c:out value="${studentListVo.studentVoList.get(index).avgScore}"/>
                                                    </td>

                                                    <td>
                                                        <a href="javascript:void(0);"
                                                           onclick="onOperateClick(${studentListVo.studentVoList.get(index).id},
                                                                   '${pageContext.request.contextPath}/student/toUpdateScore.action')"
                                                        >录入</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);"
                                                           onclick="onOperateClick(${studentListVo.studentVoList.get(index).id},
                                                                   '${pageContext.request.contextPath}/student/toChooseSubject.action')"
                                                        >选课</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            <a class="green" href="javascript:void(0);"
                                                               onclick="onOperateClick(${studentListVo.studentVoList.get(index).id},
                                                                       '${pageContext.request.contextPath}/student/toUpdate.action')">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>

                                                            <a class="red" href="#modal-message" role="button"
                                                               onclick="onDeleteClick(${studentListVo.studentVoList.get(index).id})"
                                                               data-toggle="modal">
                                        ...
                                        <div class="modal-footer no-margin-top">
                                            ...
                                            <ul class="pagination pull-right no-margin">
                                                ...
                                                <c:choose>
                                                <c:when test="${!studentListVo.pageVo.hasPrevious}">
                                                ...
                                                <c:forEach var="index" begin="1" end="${studentListVo.pageVo.pageCount}"
                                                           step="1">

                                                    <c:choose>
                                                        <c:when test="${studentListVo.pageVo.pageIndex == index}">
                                                            <li class="active">
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li>
                                                ...
                                                <c:choose>
                                                <c:when test="${!studentListVo.pageVo.hasNext}">
                                                ...
                                                <li class="next">
                                                    <a href="javascript:void(0);"
                                                       onclick="onPageClick(${studentListVo.pageVo.pageCount})">
                                                        </c:otherwise>
                                                        </c:choose>
                                                        <i class="ace-icon fa fa-angle-double-right"></i>
                                                    </a>
