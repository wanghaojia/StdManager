            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li>
                        ...
                        <a href="${pageContext.request.contextPath}/student/list">主页</a>
                    </li>

                    <li>
                        <a href="#">信息录入</a>
                    </li>
                    <li class="active">录入分数</li>
                </ul><!-- /.breadcrumb -->
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="${pageContext.request.contextPath}/student/updateScore.action" method="post">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <c:choose>
                                        <c:when test="${studentVo.scoreVoList.size() > 0}">
                                            ...
                                            <div class="table-responsive">
                                                <table id="simple-table"
                                                    ...
                                                    <c:forEach var="index" begin="0"
                                                               end="${studentVo.scoreVoList.size()-1}" step="1">
                                                        <tr>
                                                            <input type="hidden" name="scoreVoList[${index}].subjectId"
                                                                   value="${studentVo.scoreVoList.get(index).subjectId}"/>
                                                            <td>
                                                                <c:out value="${index+1}"/>
                                                            </td>

                                                            <td>
                                                                <c:out value="${studentVo.scoreVoList.get(index).subjectName}"/>
                                                            </td>
