        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="grey dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="http://ace.jeka.by/form-elements.html#">
                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content ace-scroll" style="position: relative;">
                            ...
                            <div class="scroll-content" style="max-height: 200px;">
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li>
                                        <a href="http://ace.jeka.by/form-elements.html#" class="clearfix">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="http://ace.jeka.by/form-elements.html#" class="dropdown-toggle">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/update.action" method="post"
                              name="myForm"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="id">学号</label>

                                <div class="col-sm-9">
                                    <input type="number" id="id" name="id" required="required" class="col-xs-10 col-sm-5"
                                           maxlength="20"
                                        value="${studentOperateVo.studentVo.id}" readonly="readonly"/>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <label>
                                        <input name="sex" type="radio" class="ace" value="0"
                                                <c:if test="${studentOperateVo.studentVo.sex == 0}">
                                                    checked="checked"
                                                </c:if>/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class=" input-group col-xs-10 col-sm-5">
                                        <input class="form-control date-picker" readonly="readonly" required="required" name="birthday"
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="gradeId">所在班级</label>
